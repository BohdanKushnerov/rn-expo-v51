...
CREATE POLICY "Allow authenicated users All operations" ON "public"."order_items" USING (true) WITH CHECK (true);

CREATE POLICY "Allow authentivated user to SELECT" ON "public"."products" TO "authenticated" USING (true) WITH CHECK (true);
